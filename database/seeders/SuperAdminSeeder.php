...
class SuperAdminSeeder extends Seeder
{
    ...
    {
        $superAdmin = [
            ['id'=>'1','name'=>'Morshed Ahmed','email'=>'superadmin@gmail.com','phone'=>'017','type'=>'Admin','status'=>'Active','designation_id'=>'1','address'=>'abc','password'=>'$2a$12$/Wla/XJzQB7ZdUl/eCCxtOnndvu/8If2xyCTdddOyD1gDhdNN7TyC']
        ];
