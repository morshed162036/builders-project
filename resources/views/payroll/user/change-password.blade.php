            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Set New Password
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('user.change-password') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control"  aria-describedby="basic-Createon1" name="email" @if (Auth::guard('web')->user()->id != 1)
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control"  aria-describedby="basic-Createon1" name="current_password" required>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            <h5>New Password</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control"  aria-describedby="basic-Createon1" name="new_password" required>
                                            </div>
                                        </fieldset>
