            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('catalogue.update',$catalogue->id) }}" method="post"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" aria-describedby="basic-Createon1" name="catalogue_name" value="{{ $catalogue->name }}" required>
                                            </div>
