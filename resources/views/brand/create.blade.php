...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Brand Create</h5>
                                    ...
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" aria-describedby="basic-Createon1" name="brand_name" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Description</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="Textarea" name="brand_description"></textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Address</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Address" aria-describedby="basic-Createon1" name="brand_address">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Logo</h5>
