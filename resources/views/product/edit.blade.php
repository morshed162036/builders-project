            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('product.update') }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset >
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" aria-describedby="basic-Createon1" name="title" value="{{ $product->title }}">
                                            </div>
                                        </fieldset>
                        ...
                        @endif  value="{{ $category['id'] }}">&nbsp;&nbsp;&nbsp;--&nbsp;{{ $category['name'] }}</option>
                                                            @foreach ($category['subcategories'] as $subcategories)
                                                                <option @if (!empty($product['category_id']==$subcategories['id']))
                                                                selected
                                                                @endif  value="{{ $subcategories['id'] }}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;---&nbsp;{{ $subcategory['name'] }}</option>
                                                            @endforeach 
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="sku" aria-describedby="basic-Createon1" name="product_code" value="{{ $product->code }}" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Description</h5>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="type" id="" class="form-control" required>
                                                    ...
                                                    <option @if ($product->type == 'Machine')
                                                        selected
                                                    @endif value="Machine">Machine</option>
                                                </select>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            @if($product->image != null)
                                                <img src="{{ asset('images/product_image/'.$product->image) }}" alt="image" width="70px" height="70px" class="mt-2 mx-1">
                                            @endif
                                        </fieldset>
                                        <img id="output">
