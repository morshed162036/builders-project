                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    @can('sale_invoice.show')
                                                                        <a class="dropdown-item" href="{{ route('invoice.show',$invoice->id) }}"><i class="bx bxs-spreadsheet mr-1"></i> Details</a>
                                                                    @endcan
                                                                    @can('sale_invoice.edit')
                                                                        <a class="dropdown-item" href="{{'invoice-edit/sell/'.$invoice->id }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    @endcan
                                                                    @can('sale_invoice.payment_history')
