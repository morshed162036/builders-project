                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item active">Advance Suppliers
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Advance Supplier List</h5>
                                            ...
                                            @if ($suppliers)
                                                @foreach ($suppliers as $supplier)
                                                    <tr>
                                                        ...
                                                        <td>@if ($supplier->supplier->company != null)
                                                            {{ $supplier->supplier->company->name}}
                                                        @else
                                                             <span>Empty</span>
                                                        @endif</td>
                                                        <td>{{ $supplier->supplier->mobile }}</td>
                                                        <td class="text-primary">#{{ $supplier->invoice_code }}</td>
                                                        <td>{{ $supplier->issue_date }}</td> 
                                                        <td>{{ $supplier->due_date }}</td>  
                                                        <td>{{ $supplier->total_amount }}</td> 
                                                        <td>{{ $supplier->payment_amount }}</td> 
                                                        <td>{{ $supplier->payment_status }}</td> 
                                                        {{-- <td>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('supplier.show',$supplier->id) }}"><i class="bx 
