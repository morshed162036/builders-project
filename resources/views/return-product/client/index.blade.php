                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @can('product_return_client.create')
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    @can('product_return_client.show')
                                                                        <a class="dropdown-item" href="{{ route('client-return-product.show',$client_refund->id) }}"><i class="bx bx-spreadsheet mr-1"></i> Details</a>
                                                                    @endcan
