        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Supplier Product Return Table</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active">Return Products To Supplier
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            @if ($return_products)
                                                @foreach ($return_products as $return_product)
                                                    <tr>
                                                        <td>{{ $return_product->supplier->name }}@if ($return_product->supplier->company)
                                                            ({{ $return_product->supplier->company->name }})
                                                        @endif</td>
                                                        <td>{{ $return_product->payment->bank_name }}({{ $return_product->payment->account_no }})</td>
                                                        <td>{{ $return_product->amount }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('supplier-return-product.show',$return_product->id) }}"><i class="bx bx-edit-alt mr-1"></i> Details</a>
