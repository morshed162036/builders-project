...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Supplier Product Return Create</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('supplier-return-product.index') }}">Supplier Product Return List</a>
                        </li>
                        <li class="breadcrumb-item active">Return Product Create
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('supplier-return-product.store') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                                ...
                                                <select name="supplier_id" id="supplier_id" class="form-control" required>
                                                    ...
                                                    @isset($suppliers)
                                                        @foreach ($suppliers as $supplier)
                                                            <option value="{{ $supplier->id }}">{{ $supplier->name }}@if ($supplier->company)
                                                                ...
                                                                <div data-repeater-item>
                                                                    <div class="row justify-content-between" id='product_details'>
                                                                        <div class="col-md-6 col-sm-12 form-group">
                                                                            ...
                                                                            <select name="client_refund_id" id="client_refund_id"
                                                                                class="form-control" >
                                                                                <option value="">Select</option>
                                                                                @isset($client_refund_details)
                                                                                    @foreach ($client_refund_details as $client_refund_detail)
                                                                                        <option value="{{ $client_refund_detail->id }}">
                                                                                            {{ $client_refund_detail->product->title }} -> invoice code:  {{ $client_refund_detail->client_refund->invoice_code }} -> qnt: {{ $client_refund_detail->qnt }} </option>
                                                                                    @endforeach
                                                                                @endisset
